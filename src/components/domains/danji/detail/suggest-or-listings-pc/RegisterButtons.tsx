...
import useCheckSuggestsOrListings from '../suggests-or-listings-mobile/hooks/useCheckSuggestsOrListings';
...
export default function RegisterButtons({ tab, danjiID, naverDanji, handleClickSuggestButton }: RegisterButtonsProps) {
  ...
  return (
    <div tw="w-full pt-5 px-5 flex flex-col gap-4">
      ...
      <NaverRealestateButton danjiID={danjiID} naverDanji={naverDanji} />
    </div>
  );
}
