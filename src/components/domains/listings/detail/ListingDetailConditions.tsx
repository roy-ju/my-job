...
export interface ListingDetailConditionsProps {
  listingDetail?: ListingDetailResponse | null;
}

export default function ListingDetailConditions({ listingDetail }: ListingDetailConditionsProps) {
  const listing = listingDetail?.listing;

  const debtSuccessions = listingDetail?.debt_successions;

  const collaterals = listingDetail?.collaterals;
