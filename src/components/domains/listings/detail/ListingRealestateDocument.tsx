...
import { Button, Moment, Separator } from '@/components/atoms';
...
interface ListingRealestateDocumentProps {
  realestateDocumentData?: ListingRealestateDocumenSummarytResponse | null;
}
...
export default function ListingRealestateDocument({ realestateDocumentData }: ListingRealestateDocumentProps) {
  const { openTooltip } = useTooltip();

  const data = realestateDocumentData;

  if (!realestateDocumentData || !realestateDocumentData?.created_time) return null;
