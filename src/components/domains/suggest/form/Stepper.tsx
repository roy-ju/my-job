...
export default function Stepper({ id }: { id?: string }) {
  ...
  // css={[hidden && tw`[visibility: hidden]`]}

  return (
    <div tw="p-5 pb-8">
      <div tw="flex items-center justify-center mb-6" id={id}>
        <AnimateStepperNumber active={getStep(0, currentIndex) === 'current'}>
          {getStep(0, currentIndex) === 'prev' ? (
            <StepChecked color={getColor(0, 1)} />
          ) : (
            <StepOne color={getColor(1, currentIndex)} css={[getStep(0, currentIndex) === 'current' && bigSize]} />
          )}
        ...
        <AnimateStepperNumber active={getStep(1, currentIndex) === 'current'}>
          {getStep(1, currentIndex) === 'prev' ? (
            ...
            <StepTwo color={getColor(2, currentIndex)} css={[getStep(1, currentIndex) === 'current' && bigSize]} />
          )}
        </AnimateStepperNumber>
        ...
        <AnimateStepperNumber active={getStep(2, currentIndex) === 'current'}>
          {getStep(2, currentIndex) === 'prev' ? (
            ...
            <StepThree color={getColor(3, currentIndex)} css={[getStep(2, currentIndex) === 'current' && bigSize]} />
          )}
        </AnimateStepperNumber>
        ...
        <AnimateStepperNumber active={getStep(3, currentIndex) === 'current'}>
          {getStep(3, currentIndex) === 'prev' ? (
            ...
            <StepFour color={getColor(4, currentIndex)} css={[getStep(3, currentIndex) === 'current' && bigSize]} />
          )}
        </AnimateStepperNumber>
        ...
        <AnimateStepperNumber active={getStep(4, currentIndex) === 'current'}>
          {getStep(4, currentIndex) === 'prev' ? (
            ...
            <StepFive color={getColor(5, currentIndex)} css={[getStep(4, currentIndex) === 'current' && bigSize]} />
          )}
        </AnimateStepperNumber>
      </div>
