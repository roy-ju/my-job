...
export default function useIcons() {
  const iconObj: Record<string, ReactNode> = {
    ...
    건물1층: <Image src={Elevator} width={20} height={20} alt="elevator" />,
    ...
    고층: <Image src={Elevator} width={20} height={20} alt="elevator" />,
    ...
    '2층이상': <Image src={Bed} width={20} height={20} alt="bed" />,
