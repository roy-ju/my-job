    ...
    <div tw="bg-white px-5 pb-10 flex flex-col">
      ...
      <div tw="flex flex-col gap-2 mb-6">
        <button
          ...
          tw="rounded-lg bg-gray-100 text-gray-1000 h-12 px-5 flex justify-between items-center hover:bg-gray-200 transition-colors"
          type="button"
        >
      ...
      <Button
        variant="ghost"
        tw="w-full border border-gray-300 h-[60px] hover:border-gray-1000 transition-colors"
