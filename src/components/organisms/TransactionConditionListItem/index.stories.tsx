...
export const Default: ComponentStory<typeof TransactionConditionListItem> = () => (
  <div tw="flex flex-col gap-2">
    ...
    <TransactionConditionListItem label="희망가" value="3억 1,000만/100만" />
    <TransactionConditionListItem label="계약금" value={1} />
    <TransactionConditionListItem label="중도금" value={1} />
    <TransactionConditionListItem label="잔금" value={1} />
    <TransactionConditionListItem label="실제지급총액" value={1} />
    <TransactionConditionListItem label="선순위담보권" value={{ name: 'Jay', amount: 1 }} />
    <TransactionConditionListItem label="입주가능시기" value="2022.03.03 이전" />
