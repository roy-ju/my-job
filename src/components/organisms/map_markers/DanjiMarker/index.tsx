...
const DanjiMarker = React.memo(({ selected = false, variant, area, price, count = 0, onClick, children }: Props) => {
  ...
  return (
    <div tw="animate-scale will-change-transform [text-rendering: optimizeSpeed] inline-block">
