          ...
          {variant === 'nego' && !area ? (
            <div tw="flex flex-col flex-1 rounded-lg shadow-[7px_7px_5px_rgba(0,0,0,0.16)]">
              <div tw="relative flex">
                <div css={[tw`flex-1 h-[23px] bg-nego rounded-tl-lg`, count === 0 && tw`rounded-tr-lg`]} />
                <div tw="absolute left-0 bottom-0 w-full h-[2px] bg-nego" />
                {count !== 0 && (
                  <>
                    <div tw="absolute top-0 right-[23px] h-[23px] w-[2px] bg-nego" />
                    <div tw="relative">
                      <MarkerRoundedCorner color="#7048E8" />
