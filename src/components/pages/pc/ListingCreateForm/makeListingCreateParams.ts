...
export default function makeListingCreateParams(args: Args) {
  ...
  const params: Record<string, unknown> = {
    ...
    interim_amount_payment_time1: args.interims[0]?.date,
    ...
    interim_amount_payment_time2: args.interims[1]?.date,
    ...
    remaining_amount_payment_time: args.remainingAmountDate,
