...
import { DanjiRealPricesListResponse } from '@/services/danji/types';

import { ChartData, DataProps, MonthStartDate } from '../../utils/chartTypes';
...
export type RealPriceChartProps = {
  ...
  realPricesPyoungList: DanjiRealPricesListResponse['list'] | [];
  danjiID?: number;
  rt?: number;
};
