...
export default function IntroSectionEight() {
  return (
    <section tw="flex flex-col items-center text-center py-[60px] md:py-[120px] px-5 md:px-10 xl:px-20 ">
      <div tw="flex gap-3 md:gap-10 justify-between mb-10 w-full md:mb-[120px]">
        <a
          tw="flex-1 hover:opacity-70 transition-opacity px-3 py-2 md:py-5 md:px-8 md:text-2xl md:leading-10 text-xs leading-5 text-white [background: linear-gradient(180deg, #715FE2 0%, #5661D1 100%)] rounded-lg [box-shadow: 0px 8px 16px rgba(0, 0, 0, 0.14)] [letter-spacing: -0.25px] md:rounded-2xl"
          target="_blank"
          href="https://youtu.be/DRaGUpMo_bo"
          rel="noopener noreferrer"
        >
          <div tw="text-left">플랫폼 소개 영상</div>
