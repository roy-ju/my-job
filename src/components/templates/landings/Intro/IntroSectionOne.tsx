    ...
    <section>
      ...
      <div tw="relative pb-[60px] md:pb-[100px] bg-nego-100 flex flex-col justify-items-start">
        ...
        <div className="intro-carousel-container" tw="md:mt-[150px]">
          <div tw="overflow-x-hidden" ref={constraintsRef}>
            <motion.div
              drag="x"
              dragConstraints={constraintsRef}
              className="intro-carousel"
              tw="mb-5 md:mb-10  flex gap-4 md:gap-[72px] h-fit"
            >
              <div
                className="intro-carousel-item"
                tw="flex flex-col shrink-0  w-[320px] h-[240px] md:h-[452px] md:w-[600px] [background: linear-gradient(90deg, #5661D1 0%, #715FE2 100%)] rounded-tr-[60px] md:rounded-tr-[120px] py-5 px-7 md:py-[60px] md:px-20 text-white"
              >
                <div tw="mb-3 md:mb-6">
                  <p tw="font-bold text-xs md:text-lg md:leading-[26px] leading-5 md:mb-0.5">네고시오 협상스토리</p>
                  <p tw="font-bold text-base md:text-[28px] md:leading-10  leading-6">
                    공인중개사가 말하는 부동산 협상
                  </p>
                </div>
                <div tw="md:text-2xl text-sm md:leading-10 leading-[22px] [letter-spacing: -0.25px]">
                  대부분의 부동산 거래는 협상의 결과입
                  <br />
                  니다. 항상 모든 정보가 공개되는 것은
                  <br /> 아닙니다. 중개사는 가격결정에 생각보
                  <br />다 많은 영향을 미칩니다.
                </div>
                <div tw="mt-auto">
              ...
              >
                <div tw="mb-3 md:mb-6">
                  <p tw="font-bold text-xs md:text-lg md:leading-[26px] leading-5 md:mb-0.5">협상의 원칙</p>
                  <p tw="font-bold text-base md:text-[28px] md:leading-10  leading-6">
                    결정권을 쥐고 있는 의사결정자를 찾아라
                  </p>
                </div>
                <div tw="md:text-2xl text-sm md:leading-10 leading-[22px] [letter-spacing: -0.25px]">
                  나의 의사가 거래당사자에게 제대로 전달되었
                  <br />
                  을까 고민하지 말고, 이제 네고시오에서 내 집을
                  <br /> 구할 때도, 내놓을 때도, 서로 원하는 가격, 조건
                  <br />을 직접 확인하고 후회없는 거래하세요.
                </div>
                <div tw="mt-auto">
                  <p tw="font-bold text-xs md:text-lg md:leading-[26px] leading-5 md:mb-0.5">김경렬</p>
                  <p tw="text-xs md:text-lg md:leading-[26px] leading-5">K파트너스 법률사무소 대표 변호사</p>
