...
export default function SectionOne() {
  return (
    <section tw="px-[30px] pt-[60px] text-center [background-color: #F3F0FF] flex flex-col items-center">
      <div>
        <h1 tw="mb-7">
        ...
        <Link
          tw="block mx-auto mb-5 bg-nego-800 text-white rounded-full w-[173px] py-3 font-bold text-sm leading-[22px]"
