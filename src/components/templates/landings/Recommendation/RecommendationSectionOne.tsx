      ...
      <section tw="max-w-[1280px] xl:mx-auto px-[30px] md:px-10 xl:px-20 pt-[60px] md:py-[70px] text-center  flex flex-col md:flex-row items-center md:justify-between">
        <div>
          ...
          <div tw="flex items-center gap-5">
            <Link
              tw="border border-nego-800 block mx-auto md:mr-auto md:ml-0 mb-5 bg-white text-nego-800 rounded-full w-[148px] md:w-[230px] py-3 md:py-[16px] font-bold md:text-[20px] text-sm leading-[22px] md:leading-[28px] hover:opacity-70 transition-opacity"
              href="/"
            >
              네고시오 바로가기
            </Link>
            <Link
              tw="block mx-auto md:mr-auto md:ml-0 mb-5 bg-nego-800 text-white rounded-full w-[148px] md:w-[230px] py-3 md:py-[16px] font-bold md:text-[20px] text-sm leading-[22px] md:leading-[28px] hover:opacity-70 transition-opacity"
              href="/recommendGuide"
            >
              네고 매물 추천받기
            </Link>
